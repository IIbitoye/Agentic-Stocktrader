...
* **Value Contrarian:** Focuses on mean reversion and overextension. This strategy prioritizes the Relative Strength Index (RSI) and distance from 52-week highs to identify "overbought" or "oversold" conditions. Their findings are then synthesized by a **Chief Evaluator Agent** to identify consensus or conflict.
